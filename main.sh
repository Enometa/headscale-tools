...
download_headscale() {
  ...
  local DOWANLOAD_URL="https://ghp.ci/https://github.com/juanfont/headscale/releases/download/${headscale_version_temp}/headscale_${headscale_version}_linux_${OS_ARCH}"
